...
namespace Movie_Cleanup.Modules.Shell.Interop.Common
{
...
#pragma warning disable 108
    ...
    interface IThumbnailCache
    {
        ...
        [In] ShellNativeMethods.WTS_FLAGS flags,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out ShellNativeMethods.WTS_CACHEFLAGS pOutFlags,
        [Out] ShellNativeMethods.WTS_THUMBNAILID pThumbnailID);

        void GetThumbnailByID([In] ShellNativeMethods.WTS_THUMBNAILID thumbnailID,
        [In] uint cxyRequestedThumbSize,
        [Out] out ISharedBitmap ppvThumb,
        [Out] out ShellNativeMethods.WTS_CACHEFLAGS pOutFlags);
    }
