...
namespace Movie_Cleanup.Modules.Shell.Interop.TaskBar
{
    internal sealed class TabbedThumbnailProxyWindow : Form, IDisposable
    {
        ...
        private Movie_Cleanup.Modules.Shell.Interop.TaskBar.TabbedThumbnail preview;

        internal TabbedThumbnailProxyWindow(TaskBar.TabbedThumbnail preview)
        {
        ...
        //public TabbedThumbnailProxyWindow(Shell.TabbedThumbnail preview)
        //{
        ...
        internal Movie_Cleanup.Modules.Shell.Interop.TaskBar.TabbedThumbnail TabbedThumbnail
        {
            get;
            private set;
        }
