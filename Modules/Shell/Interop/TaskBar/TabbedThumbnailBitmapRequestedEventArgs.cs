...
namespace Movie_Cleanup.Modules.Shell.Interop.TaskBar
{
    ...
    public class TabbedThumbnailBitmapRequestedEventArgs : TabbedThumbnailEventArgs
    {
        ...
        public TabbedThumbnailBitmapRequestedEventArgs(IntPtr windowHandle, Modules.Shell.Interop.TaskBar.TabbedThumbnail preview)
        ...
        /// <param name="preview">TabbedThumbnail related to this event</param>
        public TabbedThumbnailBitmapRequestedEventArgs(UIElement windowsControl, Modules.Shell.Interop.TaskBar.TabbedThumbnail preview)
