...
namespace Movie_Cleanup.Modules.Shell
{
    ...
    //        {
    //            short val;
    //            PropVariantNativeMethods.PropVariantGetInt16Elem(ref pv, i, out val);
    ...
    //        {
    //            ushort val;
    //            PropVariantNativeMethods.PropVariantGetUInt16Elem(ref pv, i, out val);
    //            array.SetValue(val, i);
    //        });
    ...
    //        {
    //            int val;
    //            PropVariantNativeMethods.PropVariantGetInt32Elem(ref pv, i, out val);
    //            array.SetValue(val, i);
    //        });
    ...
    //        {
    //            uint val;
    //            PropVariantNativeMethods.PropVariantGetUInt32Elem(ref pv, i, out val);
    //            array.SetValue(val, i);
    //        });
    ...
    //        {
    //            long val;
    //            PropVariantNativeMethods.PropVariantGetInt64Elem(ref pv, i, out val);
    //            array.SetValue(val, i);
    //        });
    ...
    //        {
    //            ulong val;
    //            PropVariantNativeMethods.PropVariantGetUInt64Elem(ref pv, i, out val);
    //            array.SetValue(val, i);
    //        });
    ...
    //            PropVariantNativeMethods.PropVariantGetFileTimeElem(ref pv, i, out val);
    ...
    //        {
    //            bool val;
    //            PropVariantNativeMethods.PropVariantGetBooleanElem(ref pv, i, out val);
    //            array.SetValue(val, i);
    //        });
    ...
    //        {
    //            double val;
    //            PropVariantNativeMethods.PropVariantGetDoubleElem(ref pv, i, out val);
    //            array.SetValue(val, i);
    //        });
    ...
    //        // left empty
    //    }
    //    PropVariant proV = new PropVariant();
    ...
    //        PropVariantNativeMethods.InitPropVariantFromStringVector(value, (uint)value.Length, out proV);
    //    }
    ...
    //        PropVariantNativeMethods.InitPropVariantFromBooleanVector(value, (uint)value.Length, out proV);
    //    }
    ...
    //        PropVariantNativeMethods.InitPropVariantFromInt16Vector(value, (uint)value.Length, out proV);
    //    }
    ...
    //        PropVariantNativeMethods.InitPropVariantFromUInt16Vector(value, (uint)value.Length, out proV);
    ...
    //        PropVariantNativeMethods.InitPropVariantFromInt32Vector(value, (uint)value.Length, out proV);
    //    }
    ...
    //        PropVariantNativeMethods.InitPropVariantFromUInt32Vector(value, (uint)value.Length, out proV);
    //    }
    ...
    //        PropVariantNativeMethods.InitPropVariantFromInt64Vector(value, (uint)value.Length, out proV);
    //    }
    ...
    //        PropVariantNativeMethods.InitPropVariantFromUInt64Vector(value, (uint)value.Length, out proV);
    //    }
    ...
    //        PropVariantNativeMethods.InitPropVariantFromDoubleVector(value, (uint)value.Length, out proV);
    //    }
    ...
    //        PropVariantNativeMethods.InitPropVariantFromFileTimeVector(fileTimeArr, (uint)fileTimeArr.Length, out proV);
    //    }
    ...
    //        PropVariantNativeMethods.InitPropVariantFromFileTime(ref ft, out proV);
    //    }
    ...
    //    {
    //        int count = PropVariantNativeMethods.PropVariantGetElementCount(ref proV);
    ...
    //    public void Dispose()
    //    {
    //        PropVariantNativeMethods.PropVariantClear(ref proV);
